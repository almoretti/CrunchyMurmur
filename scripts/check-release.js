...
if (pkg.build?.mac?.x64ArchFiles !== 'Contents/Resources/native/transcriber/*.dylib') failures.push('macOS universal packaging does not permit the bundled Intel ONNX support libraries.');
